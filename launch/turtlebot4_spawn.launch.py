...
def generate_launch_description():
    ...
    #Modified path. Using the descritpion of this package (in the original 'turtlebot4_spawn.launch.py' it uses 'turtlebot4_description' package)
    #I'm doing this because the original one doesn't have IMU plugin for Gazebo Ignition.
    pkg_turtlebot4_path_planning = get_package_share_directory(
        'turtlebot4_path_planning')
    ...
    turtlebot4_ros_ign_bridge_launch = PathJoinSubstitution(
        [pkg_turtlebot4_path_planning, 'launch', 'ros_ign_bridge.launch.py'])
    ...
    robot_description_launch = PathJoinSubstitution(
        [pkg_turtlebot4_path_planning, 'launch', 'robot_description.launch.py'])
